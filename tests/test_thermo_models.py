...
import numpy
import pytest
from chempy.thermo import ThermoGAModel, WilhoitModel, NASAPolynomial, NASAModel, ThermoError
...
class TestThermoModels:
    ...
    def test_thermo_ga_model(self):
        ...
        T = 298.15
        expected_H = H298 + Cpdata[0] * (T - 298.15) # Wait, it doesn't quite do that.
