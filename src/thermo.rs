...
mod tests {
    ...
    fn test_wilhoit_regression() {
        ...
        let t_list = [200.0, 400.0, 600.0, 800.0, 1000.0, 1200.0, 1400.0, 1600.0, 1800.0, 2000.0];
        let cp_expected = [
        ...
        let s_expected = [
            287.421, 341.892, 384.685, 420.369, 450.861, 477.360, 500.708, 521.521, 540.262, 557.284,
        ];
